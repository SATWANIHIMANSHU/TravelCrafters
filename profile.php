...
// Fetch user details
$stmt = $conn->prepare("SELECT username, email,mobile,profile_image,address,created_at FROM users WHERE user_id = ?");
...
<body>
        ...
        <div class="container">
            <div class="profile-container text-center p-4">
                ...
                <div class="d-flex justify-content-center">
                    <img src="uploads/<?php echo htmlspecialchars($user['profile_image'] ?? 'team-1.jpg'); ?>"
                ...
                <p class="text-muted">Joined on: <?php echo date("F j, Y", strtotime($user['created_at'])); ?></p>
                ...
                <div class="profile-info text-start">
                    ...
                    <h5>Phone:</h5>
                    <p><?php echo htmlspecialchars($user['mobile'] ?? 'Not Provided'); ?></p>
    
                    <h5>Address:</h5>
                    <p><?php echo htmlspecialchars($user['address'] ?? 'Not Provided'); ?></p>
    
                    <h5>Total Bookings:</h5>
                    <p><?php echo $total_bookings; ?> Completed</p>
                </div>
   ...
   <!-- ✅ Bootstrap Modal to View Medium Image -->
