        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4">Welcome to <span class="text-primary">TravelCrafters</span></h1>
                    <p class="mb-4">Welcome to TravelCrafters, your ultimate travel partner! We are passionate about crafting unforgettable journeys that take you to breathtaking destinations, rich cultural experiences, and seamless adventures.</p>
                    <p class="mb-4"> Whether you're looking for a relaxing getaway, an adventurous expedition, or a customized tour, we have the perfect package for you.</p>
