...
$searchQuery = $destinationFilter = $priceFilter = "";
...
if (isset($_GET['price_range'])) {
    $priceFilter = $_GET['price_range'];
}

// Nights Filter
if (isset($_GET['nights'])) {
    $nightsFilter = (int)$_GET['nights'];
}

// Construct SQL Query
$sql = "SELECT p.id, p.name, p.duration, p.original_price, p.old_price, pi.image_url 
        FROM packages p 
        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="show_packages.php" class="nav-item nav-link active">Packages</a>
    ...
    <div class="container-xxl py-5">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-3">
                                <select name="price_range" id="price_range" class="form-select">
                                    ...
                                    <option value="1000000-9999999">Above 10,00,000</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <select name="nights" id="nights" class="form-select">
                                    ...
                                    <option value="21-30">21 - 30 Nights</option>
                                    <option value="31-999">More than 30 Nights</option>
                                </select>
                            </div>
                            <div class="col-md-1">
        ...
        <script>
            $(document).ready(function () {
                ...
                // Fetch initial packages on page load
                fetchPackages();
                ...
                $('#price_range, #nights').on('change', function () {
                    fetchPackages();
                });
            });

            function fetchPackages() {
                $('#packageList').html('<div class="text-center my-3"><div class="spinner-border text-primary" role="status"><span class="visually-hidden">Loading...</span></div></div>');
