...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">
            <h6 class="section-title bg-white text-center text-primary px-3">Terms & Conditions</h6>
            <h1 class="mb-4">Know Before You Travel</h1>
            <p class="text-muted">Please read these terms carefully before booking or using our services.</p>
        </div>
            ...
            <div class="col-lg-10">
                <ul class="list-group shadow-lg rounded">
                    <li class="list-group-item py-4 px-4 mb-3 rounded bg-light border-0 wow fadeInUp" data-wow-delay="0.1s">
                        <h5 class="text-primary mb-2">1. Booking Confirmation</h5>
                        <p class="mb-0">All bookings are confirmed only after receiving full or partial payment, as specified for each package.</p>
                    </li>
                    <li class="list-group-item py-4 px-4 mb-3 rounded bg-light border-0 wow fadeInUp" data-wow-delay="0.2s">
                        <h5 class="text-primary mb-2">2. Cancellation & Refund</h5>
                        <p class="mb-0">Cancellations must be made in advance. Refund policies vary by package and are clearly mentioned during booking.</p>
                    </li>
                    <li class="list-group-item py-4 px-4 mb-3 rounded bg-light border-0 wow fadeInUp" data-wow-delay="0.3s">
                        <h5 class="text-primary mb-2">3. Travel Documents</h5>
                        <p class="mb-0">Passengers must carry valid ID proof and necessary travel documents. We are not responsible for denial of service due to missing documents.</p>
                    </li>
                    <li class="list-group-item py-4 px-4 mb-3 rounded bg-light border-0 wow fadeInUp" data-wow-delay="0.4s">
                        <h5 class="text-primary mb-2">4. Payment Terms</h5>
                        <p class="mb-0">All payments must be completed within the timeline provided. Delay may lead to cancellation without notice.</p>
                    </li>
                    <li class="list-group-item py-4 px-4 mb-3 rounded bg-light border-0 wow fadeInUp" data-wow-delay="0.5s">
                        <h5 class="text-primary mb-2">5. Changes & Modifications</h5>
                        <p class="mb-0">We reserve the right to modify itineraries or services due to unforeseen circumstances or operational issues.</p>
                    </li>
                    <li class="list-group-item py-4 px-4 mb-3 rounded bg-light border-0 wow fadeInUp" data-wow-delay="0.6s">
                        <h5 class="text-primary mb-2">6. Health & Safety</h5>
                        <p class="mb-0">Travelers must follow safety instructions during the trip. We are not liable for any accidents caused by negligence.</p>
                    </li>
                    <li class="list-group-item py-4 px-4 mb-3 rounded bg-light border-0 wow fadeInUp" data-wow-delay="0.7s">
                        <h5 class="text-primary mb-2">7. Conduct</h5>
                        <p class="mb-0">Unruly behavior or violation of rules during the trip can result in termination of service without refund.</p>
                    </li>
                    <li class="list-group-item py-4 px-4 rounded bg-light border-0 wow fadeInUp" data-wow-delay="0.8s">
                        <h5 class="text-primary mb-2">8. Legal Jurisdiction</h5>
                        <p class="mb-0">All disputes are subject to the legal jurisdiction of the courts located in Gujarat.</p>
                    </li>
                </ul>
            </div>
        </div>
