...
<body>
    ...
    <tbody>
        ...
        $query = "SELECT * FROM package_availability"; // Fetch package availability data
        ...
        while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
                ...
                <td class="text-center">
                    <!-- Edit Button -->
                    <form action="edit_availability.php" method="GET" style="display:inline;">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                        <button type="submit" class="btn btn-primary btn-sm">Edit</button>
                    </form>

                    <!-- Delete Button -->
                    <form action="delete_availability.php" method="POST" style="display:inline;">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
