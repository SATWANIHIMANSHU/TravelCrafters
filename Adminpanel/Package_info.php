...
<table id="usersTable" class="display table-responsive card">
    ...
    //    $query = "SELECT p.id, p.name, d.name AS destination_name, p.original_price, p.duration, p.created_at 
    //              FROM packages p 
    //              INNER JOIN destinations d ON p.destination_id = d.id"; // Fetch packages with destination name
       $query ="SELECT * FROM `packages`";
        ...
        while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
                ...
                <td><?php echo $row['is_customizable']; ?></td>
                <td><?php echo $row['is_expert_choice']; ?></td>
                <td><?php echo $row['created_at']; ?></td>
                
                <td>
    <a href="edit_package.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Edit</a>
