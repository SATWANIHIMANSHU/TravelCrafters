...
<body>
    ...
    <li class="nav-item">
        ...
        <table id="exclusionTable" class="display table-striped-bg-*states w-100">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Package ID</th>
            ...
            <tbody>
                ...
                $query = "SELECT * FROM exclusions"; // Fetch inclusions data
                ...
                while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td>
                    <!-- Edit Button -->
                    <form action="edit_exclusion.php" method="GET" style="display:inline;">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                        <button type="submit" class="btn btn-primary btn-sm">Edit</button>
                    </form>

                    <!-- Delete Button -->
                    <form action="delete_exclusion.php" method="POST" style="display:inline;">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                        <button type="submit" class="btn btn-danger btn-sm" 
                            onclick="return confirm('Are you sure you want to delete this exclusion?');">
                            Delete
                        </button>
                    </form>
                </td>
