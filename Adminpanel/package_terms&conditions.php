...
<body>
    ...
    <?php
        ...
        $query = "SELECT * FROM terms_conditions"; // Fetch terms & conditions data
        ...
        while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
                ...
                <td class="text-center">
                    <!-- Edit Button -->
                    <form action="edit_terms.php" method="GET" style="display:inline;">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                        <button type="submit" class="btn btn-primary btn-sm">Edit</button>
                    </form>

                    <!-- Delete Button -->
                    <form action="delete_terms.php" method="POST" style="display:inline;">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
