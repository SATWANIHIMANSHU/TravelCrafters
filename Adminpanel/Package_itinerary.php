...
<table id="usersTable" class="display table-responsive card">
    ...
    <?php
        ...
        $query = "SELECT * FROM itinerary"; // Fetch itinerary data
        ...
        while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
                ...
                <td>Day <?php echo $row['day_number']; ?></td>
                <td><?php echo htmlspecialchars($row['title']); ?></td>
                <td><?php echo htmlspecialchars($row['description']); ?></td>
                <td>
    <!-- Edit Button -->
    <form action="edit_itinerary.php" method="GET" style="display:inline;">
        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
        <button type="submit" class="btn btn-primary btn-sm">Edit</button>
    </form>

    <!-- Delete Button -->
    <form action="delete_itinerary.php" method="POST" style="display:inline;">
        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
