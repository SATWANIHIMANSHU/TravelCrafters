...
<style>
    ...
    .form-section { 
        ...
        .btn-remove {
         ...
         /* Container for the table to make it full width */
    .table-container {
        width: 100%;
        padding: 20px;
    }

    /* Making table full width */
    table {
        width: 100%;
...
<body>
    ...
    <table id="packageImagesTable" class="display">
        <thead>
            <tr>
                <th>ID</th>
                <th>Package ID</th>
        ...
        <tbody>
            ...
            $query = "SELECT * FROM package_images"; // Fetch images
            ...
            while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td>
                        <img src="../uploads/<?php echo htmlspecialchars($row['image_url']); ?>" alt="Package Image" class="tbimages">
                    </td>
                    <td>
    <form action="edit_image.php" method="GET" style="display:inline;">
        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
        <button type="submit" class="btn btn-primary btn-sm">Edit</button>
    </form>

    <form action="delete_image.php" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this image?');">
        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
