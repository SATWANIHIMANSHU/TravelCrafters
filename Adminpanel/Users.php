...
<table id="usersTable" class="display table-responsive card">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo $row['created_at']; ?></td> <!-- Display Created Date -->
            <td>
                <a href="edit_user.php?id=<?php echo $row['user_id']; ?>" class="btn btn-warning" >Edit</a>
                <a href="delete_user.php?id=<?php echo $row['user_id']; ?>" onclick="return confirm('Are you sure?');" class="btn btn-danger btn-sm">Delete</a>
            </td>
        </tr>
        <?php } ?>
    </tbody>
