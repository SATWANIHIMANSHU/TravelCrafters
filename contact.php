        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h5>Get In Touch</h5>
                    <p class="mb-4">"Have questions or need assistance? We're here to help! Reach out to us, and we'll get back to you as soon as possible."</p>
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">Gala Argos, 5th Floor Ellis Bridge , Ahmedabad , Gujarat</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-4">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">info@travelcrafter.com</p>
                        </div>
                    </div>
                </div>
